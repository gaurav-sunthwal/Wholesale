...
const paymentMethods = [
  {
    ...
    className:
      "bg-white border border-gray-300 rounded px-2 sm:px-3 py-1 sm:py-2 text-blue-600 font-bold text-xs sm:text-sm whitespace-nowrap",
  },
  {
    type: "visa",
    label: "Visa",
    extra: "Electron",
    className:
      "bg-white border border-gray-300 rounded px-2 sm:px-3 py-1 sm:py-2 text-blue-600 font-bold text-xs sm:text-sm",
  },
  {
    type: "maestro",
    className:
      "bg-white border border-gray-300 rounded px-2 sm:px-3 py-1 sm:py-2 flex items-center",
  },
  {
    type: "mastercard",
    className:
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-3 max-w-md mx-auto lg:mx-0">
                {paymentMethods.map((method) => {
                  if (method.type === "text") {
                    return (
                      <div key={method.label} className={method.className}>
                        {method.label}
                      </div>
                    );
                  }
                  if (method.type === "visa") {
                    return (
                      <div key="visa" className={method.className}>
                        <div>Visa</div>
                        <div className="text-xs">{method.extra}</div>
                      </div>
                    );
                  }
                  if (method.type === "maestro") {
                    return (
                      <div key="maestro" className={method.className}>
                  ...
                  if (method.type === "mastercard") {
                    return (
                      <div key="mastercard" className={method.className}>
